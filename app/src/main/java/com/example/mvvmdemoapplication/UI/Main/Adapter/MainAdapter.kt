package com.example.mvvmdemoapplication.UI.Main.Adapter
...
class MainAdapter(
    ...
    class DataViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(user: User) {
            itemView.findViewById<TextView>(R.id.textViewUserName).setText(user.name);
            itemView.findViewById<TextView>(R.id.textViewUserEmail).setText(user.email);
